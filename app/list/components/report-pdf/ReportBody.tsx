                        ...
                        <View style={{ marginBottom: 15 }}>
                            ...
                            <View style={getTableWrapStyle()}>
                                ...
                                {group.items.map((row: any, idx: number) => {
                                    if (row.isGroup) {
                                        return (
                                            <View key={idx} style={[getRowStyle(), { paddingVertical: 6, paddingHorizontal: 6, backgroundColor: '#ffffff' }]} wrap={false}>
                                    ...
                                    if (row.inputType === 'Big') {
                                        ...
                                        return (
                                            <View key={idx} style={[getRowStyle(), { backgroundColor: isStriped ? '#f8fafc' : '#ffffff' }]} wrap={false}>
                                                ...
                                                <View style={[{ flex: 1, paddingHorizontal: 6, paddingVertical: 4, flexDirection: 'column', justifyContent: 'center' }, getCellBorder(true)]}>
                                        ...
                                        <View key={idx} style={[getRowStyle(), { backgroundColor: isStriped ? '#f8fafc' : '#ffffff' }]} wrap={false}>
                                            <View style={[{ width: paramColWidth }, getCellBorder(false)]}>
                                                ...
                                                {showMethodCol && methodDisplay === 'beneath' && row.method ? (
                                                    <Text style={{ fontSize: bFontSize - 2, fontFamily: getPdfFontName(rawFont, false), color: '#475569', paddingHorizontal: 6, paddingBottom: 4 }}>Method: {row.method}</Text>
                                                ) : null}
                                            </View>
                                            ...
                                            {/* BULLETPROOF: Strict Ternary */}
                                            {showUnitCol ? (
                                                <View style={[{ width: unitColWidth, paddingRight: 4 }, getCellBorder(!showRefRangeCol && !(showMethodCol && methodDisplay === 'column'))]}>
                            ...
                            {group.interpretationBlocks && group.interpretationBlocks.length > 0 ? (
                                <View style={{ marginTop: 12, paddingTop: 4 }} wrap={false}>
                            ...
                            {group.noteBlocks && group.noteBlocks.length > 0 ? (
                                <View style={{ marginTop: 8, paddingTop: 4 }} wrap={false}>
