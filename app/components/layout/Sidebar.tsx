      ...
      <aside className={`sleek-scrollbar ${isSidebarOpen ? 'w-52' : 'w-[80px]'} transition-all duration-300 flex flex-col shadow-[4px_0_24px_rgba(149,117,205,0.1)] border-r border-[#d1c4e9] h-full overflow-y-auto overflow-x-hidden shrink-0 z-40`} style={{ background: 'linear-gradient(to bottom, #e8eaf6, #f3e5f5)' }}>
        <nav className="flex-1 py-4 flex flex-col justify-between h-full w-full">
          <div className="space-y-1 w-full"> 
            ...
            {canSee(['Dashboard']) && (
                <Link href="/" onClick={() => setActiveView('dashboard')} className={getResponsiveLiClass(currentView === 'dashboard', false)}>
            ...
            {canSee(['Registration']) && (
                <Link href="/registration" onClick={() => setActiveView('registration')} className={getResponsiveLiClass(currentView === 'registration', true)}>
            ...
            {canSee(['Result Entry']) && (
                <Link href="/results/entry" onClick={() => setActiveView('entry')} className={getResponsiveLiClass(currentView === 'entry', true)}>
            ...
            {canSee(['Patient List']) && (
                <Link href="/list" onClick={() => setActiveView('list')} className={getResponsiveLiClass(currentView === 'list', true)}>
            ...
            {canSee(['Tests', 'Parameters', 'Test Formats', 'Packages']) && (
                <Link href="/tests" onClick={() => setActiveView('tests')} className={getResponsiveLiClass(currentView === 'tests', false)}>
            ...
            {hasSensitivity && canSee(['Tests', 'Parameters']) && (
                <Link href="/sensitivity" onClick={() => setActiveView('sensitivity')} className={getResponsiveLiClass(currentView === 'sensitivity', false)}>
            ...
            {canSee(['Departments', 'Specimens', 'Vacutainers', 'Methods', 'UOM', 'Operators', 'Lab Lists']) && (
                <Link href="/masters" onClick={() => setActiveView('masters')} className={getResponsiveLiClass(currentView === 'masters', false)}>
            ...
            {canSee(['Referrals']) && (
                <Link href="/referrals" onClick={() => setActiveView('referrals')} className={getResponsiveLiClass(currentView === 'referrals', false)}>
            ...
            {canSee(['General Settings']) && (
                <Link href="/lab-profile" onClick={() => setActiveView('lab-profile')} className={getResponsiveLiClass(currentView === 'lab-profile', false)}>
            ...
            {canSee(['Header Setup', 'Body Settings', 'Footer Layout', 'Page Formatting']) && (
                <Link href="/reports" onClick={() => setActiveView('reports')} className={getResponsiveLiClass(currentView === 'reports', false)}>
            ...
            {canSee(['User Setup', 'Roles', 'Permissions', 'Doctor Signatures']) && (
                <Link href="/authorizations" onClick={() => setActiveView('authorizations')} className={getResponsiveLiClass(currentView === 'authorizations', false)}>
          ...
          {orgId === 1 && (
            <div className="mt-auto pt-4 pb-2 border-t border-[#d1c4e9]/50 w-full space-y-1">
              <Link href="/super-admin" onClick={() => setActiveView('super-admin')} className={getResponsiveLiClass(currentView === 'super-admin', false)}>
              ...
              <Link href="/super-admin/admins" onClick={() => setActiveView('super-admin-admins')} className={getResponsiveLiClass(currentView === 'super-admin-admins', false)}>
